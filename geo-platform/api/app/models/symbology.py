...
class LayerStyle(Base):
    ...
    renderer: Mapped[dict] = mapped_column(nullable=False, default=dict)
    label_config: Mapped[dict | None] = mapped_column(nullable=True)
    popup_config: Mapped[dict | None] = mapped_column(nullable=True)
